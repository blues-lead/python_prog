...
class Dicegame:
    ...
    def initialize_game(self):
        ...
        self.__dice1Label.configure(image=self.__dicepics[1])
        self.__dice2Label.configure(image=self.__dicepics[1])
        self.__dice3Label.configure(image=self.__dicepics[1])
    ...
    def throw(self):
        ...
        self.__dice2Label.configure(image=self.__dicepics[random.randint(0,5)])
        self.__dice3Label.configure(image=self.__dicepics[random.randint(0,5)])
        self.__p_kerta += 1
        if self.__p_kerta < 30:
            self.__window.after(50, self.throw)
        else:
            self.__p_kerta = 0
